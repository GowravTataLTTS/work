...
class TestRouter(unittest.TestCase):
    ...
    def test_01_token_creation_success(self):
        response = self.app.get("/token", auth=("admin", "password"))
        self.assertEqual(200, response.status_code)

    def test_02_create_record_success(self):
        token_generated = self.app.get("/token", auth=("admin", "password"))
    ...
    def test_12_token_creation_success(self):
        response = self.app.get("/token", auth=("admin", "nopassword"))
